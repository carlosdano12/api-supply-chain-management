...
export class cultivo21613802575720 implements MigrationInterface {
  name = 'cultivo21613802575720';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TABLE `cultivo_siembras` ADD `asociadoIdAsociado` varchar(36) NULL');
    await queryRunner.query('ALTER TABLE `cultivo_siembras` ADD `niameIdNiame` varchar(36) NULL');
    await queryRunner.query('ALTER TABLE `cultivo_cosecha` ADD `cultivoIdCultivo` varchar(36) NULL');
    await queryRunner.query('ALTER TABLE `cultivo_cosecha` ADD `asociadoIdAsociado` varchar(36) NULL');
